...
When users ask about workouts, run commands from that repo and prefer JSON output:
...
- Always load `/workspace/extra/train/.env` before Train CLI commands so Supabase credentials are available.
